...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 3600, // 更新缓存间隔 单位(秒)；即每个页面有3600秒(1小时)的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。（002 C-5 澄清，2026-09-09 确认为 1 小时）
